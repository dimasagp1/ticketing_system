            ...
            <div class="brand-header">
                <a href="{{ route('home') }}" style="text-decoration: none; color: inherit;">
                    <div class="brand-logo-badge">
                        <span style="background: var(--toon-yellow); color: black; border: 2px solid black; border-radius: 50%; width: 26px; height: 26px; display: inline-flex; align-items: center; justify-content: center;">T</span>
                        TOONWORLD REGISTRATION
                    </div>
                </a>
